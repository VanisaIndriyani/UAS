...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('asset/public/css/styles2.css') }}" rel="stylesheet" />
    </head>
    <body class="d-flex flex-column h-100">
       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-secondary"></span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            ...
                            <li class="nav-item"><a class="nav-link {{ Request::is('profile*') ? 'active' : ''}}" href="{{ route('profile') }}">Produk</a></li>
